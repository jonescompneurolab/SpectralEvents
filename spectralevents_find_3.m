function specEv_struct = spectralevents_find_3(eventBand, thrFOM, tVec, fVec, TFR, classLabels)
% SPECTRALEVENTS_FIND_3 Algorithm for finding and calculating spectral 
...
%      averaged)
%   3) Of the remaining maxima, pick out maxima within the frequency band 
%      of interest
%   4) Identify and organize event features
%
% specEv_struct = spectralevents_find_3(eventBand,thrFOM,tVec,fVec,TFR,classLabels)
% 
% Inputs:
