function SpecEvents = SpectralEventAnalysis(rhythm_band_inds, thrFOM, tVec, fVec, prestim_TFR_yes_no, YorN)
...
SpecEvents.TrialSummary = struct('YorN',YorN,'numtrials',numtrials,'sumind',sumind,'specialinds',specialinds,'trialSummary',trialSummary,'trialSummary_pcm',trialSummary_pcm);
SpecEvents.Events = struct('rhythmmedian',rhythmmedian,'thr',thr,'rhythmevents_columnlabel',rhythmevents_columnlabel,'rhythmevents',rhythmevents);
SpecEvents.IEI = struct('rhythmIEI',rhythmIEI,'rhythmIEIY',rhythmIEIY,'rhythmIEIN',rhythmIEIN);
